...
const API_URL = process.env.REACT_APP_API_URL || 'https://newsapi.org/v2';
...
export class News extends Component {
  ...
  fetchMoreData = async () => {
    ...
    if (filterApplied) {
      ...
      url = `${API_URL}/top-headlines?country=${country}&category=${category}&from=${fromDate}&to=${toDate}&apiKey=${apiKey}&page=${page + 1}&pageSize=${pageSize}`;
    }
